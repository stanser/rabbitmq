...
//------------
//node_modules/jasmine-node/bin/jasmine-node - node-jasmine location
//------------
...
describe("Broker", function() {
    ...
    it("should have arrOfMsg[] of 'countOfMsg' elements", function() {
        var arr = [];
        ...
        it ("sendMsg.interval should be called with function"), function() {
            var foo = jasmine.createSpy('foo');
            foo = brocker.sendMsg.self;
            //var t = foo(12);
